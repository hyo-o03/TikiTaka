...
<head>
    ...
    <script>
		...
		function validateAddress() {
            const radios = document.getElementsByName("ftDistancePref");
            let selected = false;
...
<body>
	<div class="container">
	    ...
	    <form action="${pageContext.request.contextPath}/friend/friendHobby" method="post" class="form-layout" onsubmit="return validateAddress();">
